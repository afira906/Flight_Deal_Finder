...
for destination in sheet_data:
    ...
    # Convert price string to comparable number
    destination_price = float(destination["price (pkr)"].replace(" PKR", "").replace(",", ""))

    if cheapest_flight.price != "N/A" and cheapest_flight.price < destination_price:
